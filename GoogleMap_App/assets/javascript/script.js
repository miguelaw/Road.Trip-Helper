...
$(document).on("click", ".giphy", function(){
    ...
    if (y.style.display === "block") {
        ...
        y.style.display = "block";
            ...
            var queryURL = "https://api.giphy.com/v1/gifs/search?q=travel&api_key=mGXUkk6sqAk5YSAWK1dfK9SNbNHpmzI6&limit=10";
